<p align="center">
  <img src=".github/icon.png?v=2" width="128" alt="SheepTap app icon">
</p>
...
[![Download SheepTap for macOS](https://img.shields.io/badge/Download-SheepTap_6_for_macOS-2ea44f?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/bestonehxh/SheepTap-app/releases/latest)

**[Get the latest release →](https://github.com/bestonehxh/SheepTap-app/releases/latest)** — download the `.zip`, unzip, and drag **SheepTap.app** into `Applications`.
